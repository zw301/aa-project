...
document.addEventListener('DOMContentLoaded', function () {
  ...
  _reactDom2.default.render(_react2.default.createElement(_root2.default, { store: (0, _store2.default)() }), rootElement);
});
...
var _reduxLogger = __webpack_require__(149);
...
var _todo_actions = __webpack_require__(81);
...
var allTodos = exports.allTodos = function allTodos(state) {
  ...
  var todoArray = todoIds.map(function (id) {
...
var toDoList = function toDoList(props) {
  return _react2.default.createElement(
    ...
    _react2.default.createElement(
      'ul',
      null,
      props.todos.map(function (td) {
        return _react2.default.createElement(_todo_list_item2.default, { key: td.id, todo: td });
      })
    )
  );
};
